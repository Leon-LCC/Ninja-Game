...
public class Water extends Item {
    ...
    public Water(Point location, Dimension size, int type) {
        this.location = location;
        this.size = size;
        this.type = type;
        try {
            images[0] = ImageIO.read(new File("assets/Object/Water1.png"));
            images[1] = ImageIO.read(new File("assets/Object/Water2.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
