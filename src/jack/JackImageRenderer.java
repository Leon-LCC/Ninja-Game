...
public class JackImageRenderer implements ImageRenderer {
    protected Jack jack;
    ...
    public JackImageRenderer(Jack jack, int widthLeftOffset, int widthRightOffset, int HeightTopOffset, int HeightBottomOffset) {
        this.jack = jack;
    ...
    public void render(Image image, Graphics g) {
        Direction face = jack.getFace();
        Rectangle range = jack.getRange();
        Rectangle body = jack.getBody();
